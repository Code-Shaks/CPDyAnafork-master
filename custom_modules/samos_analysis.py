...
import sys
import itertools
from custom_modules.samos_utils import get_terminal_width 
from scipy.stats import linregress
from scipy.signal import convolve
from custom_modules.samos_trajectory import check_trajectory_compatibility, Trajectory
from custom_modules.samos_utils import AttributedArray
from custom_modules.samos_utils import InputError
...
class DynamicsAnalyzer(object):
    ...
    def get_msd(self, decomposed=False, atom_indices=None, **kwargs):
        ...
        **kwargs
        ...
        """
        from custom_modules.mdutils import (
    ...
    def get_kinetic_energies(self, stepsize=1, decompose_system=True,
        ...
        """
        from custom_modules.samos_utils import amu_kg, kB
...
def util_msd(trajectory_path, stepsize=1, species=None,
    ...
    if plot or savefig:
        from custom_modules.samos_plotting import plot_msd_isotropic
...
def get_gaussian_density(trajectory, element=None, outputfile='out.xsf',
    ...
    """
    from custom_modules.gaussian_density import make_gaussian_density
...
if __name__ == '__main__':
    ...
    from custom_modules.samos_io import read_positions_with_ase
    ap = ArgumentParser()
...
class RDF(BaseAnalyzer):
    ...
    def run_fort(self, radius=None, species_pairs=None, istart=0, istop=None, stepsize=1, nbins=100):
        ...
        from custom_modules.rdf import calculate_rdf
...
class AngularSpectrum(BaseAnalyzer):
    ...
    def run(self, radius=None, species_pairs=None, istart=1, istop=None, stepsize=1, nbins=100):
        ...
        """
        from custom_modules.rdf import calculate_angular_spec
        atoms = self._trajectory.atoms
        positions = self._trajectory.get_positions()
        if istop is None:
            istop = len(positions)
...
def util_rdf_and_plot(trajectory_path, radius=5.0, stepsize=1, bins=100,
    ...
    if plot or savefig:
        from custom_modules.samos_plotting import plot_rdf
        from matplotlib import pyplot as plt
        from matplotlib.gridspec import GridSpec
        fig = plt.figure(figsize=(4, 3))
